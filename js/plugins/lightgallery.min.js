  ...
  (function () {
      ...
      if (
        ...
        if (!$el.hasClass("lg-has-video")) {
          ...
          var _loadVideo = function (_src, _html) {
            $el
              .find(".lg-video")
              .append(_this.loadVideo(_src, "", !1, _this.core.index, _html));
            if (_html) {
    ...
    function onHasVideo(event, index, src, html) {
      ...
      _this.core.$slide
        .eq(index)
        .find(".lg-video")
        .append(_this.loadVideo(src, "lg-object", !0, index, html));
      if (html) {
        if (_this.core.s.videojs) {
          try {
            videojs(
          ...
          setTimeout(function () {
            a("#lg-share-facebook").attr(
              ...
              "https://www.facebook.com/sharer/sharer.php?u=" +
                encodeURIComponent(
                  b.getSahreProps(e, "facebookShareUrl") || window.location.href
                )
            ),
